  ...
  <div v-if="currentProduct" class="edit-form">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div class="form-group">
        ...
        <input
          type="text"
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"          id="price"
      ...
      <div class="form-group">
        <label class="block text-gray-700 text-sm font-bold mb-2" for="time">Available : </label>
    ...
    <button class=" bg-red-700 hover:bg-red-900 text-white font-bold py-1 px-4 rounded-full" @click="deleteProduct">
      Delete
    </button>
